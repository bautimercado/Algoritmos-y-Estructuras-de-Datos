...
/*El agregar al principio reacomoda el nodo inicial junto con el nodo nuevo
 * El agregarEn recorre la lista hasta la posicion indicada, acomoda el nuevo nodo
 * junto con un nodo anterior y un actual
 * El agregarFinal reacomoda el nodo final junto con el nuevo nodo, si es el primer
 * nodo de la lista, el nuevo nodo es igual a inicio y fin*/
